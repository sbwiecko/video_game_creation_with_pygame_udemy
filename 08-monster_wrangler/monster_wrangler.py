...
class Game():
    ...
    After __init__ it updates, ie, check times and call check_collision,
    and draws all the sprites/groups on the surface. It also chec for collision,
    starts new round, chooses new target, pause and reset the game,
    all four methods used in check_collision.
    """
    def __init__(self, player, monster_group):
        ...
        self.round_time = 0 # a kind of clock
        self.frame_count = 0 # help counting the clock
    ...
    def update(self):
        ...
        self.frame_count += 1
        if self.frame_count == FPS: # eg, with 60 FPS, each 60 frames = 1 second
            self.round_time += 1
            self.frame_count = 0
    ...
    def draw(self):
        ...
        # nothing to do with the draw method used in the Sprite Groups !
        #Set colors
        WHITE = (255, 255, 255)
        BLUE = (20, 176, 235)
        GREEN = (87, 201, 47)
    ...
    def check_collisions(self):
        ...
        # new collision method introduced here `spritecollideany`
        ...
        if collided_monster:
            ...
            if collided_monster.type == self.target_monster_type:
                ...
                if (self.monster_group):
                    #There are more monsters to catch (list not empty)
    ...
    def start_new_round(self):
        ...
        self.monster_group.empty() # see https://stackoverflow.com/questions/41449323/clearing-a-group-in-python
        # for monster in self.monster_group:
        #     self.monster_group.remove(monster)

        #Add monsters to the monster group, one of each color
...
#Create a player group and Player object, needed for update and draw
# let's try to keep a single Player Sprite as group isn't really used
...
while running:
    ...
    my_player.update()
    display_surface.blit(my_player.image, my_player.rect)
