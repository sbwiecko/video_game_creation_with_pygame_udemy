...
pygame.mixer.music.set_volume(0.75) # decreases music volume
...
while running:
    ...
    if keys[pygame.K_UP] and player_rect.top > 100 + 2: # horizontal line weight
    ...
    # good to blit the HUD before game over check for the situation when lives=0
    # beware to fill black before blitting the HUD !
