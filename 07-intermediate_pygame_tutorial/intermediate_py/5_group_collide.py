...
class Game():
    ...
    def check_collisions(self):
        # test if a group of sprites hits another group
        pygame.sprite.groupcollide(
            groupa=self.monster_group,
            groupb=self.knight_group,
            dokilla=True, # remove collided sprite from groupa
            dokillb=False, # remove collided sprite from groupb
        )
