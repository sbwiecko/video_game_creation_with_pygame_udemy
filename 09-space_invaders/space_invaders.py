...
BREACH_LINE = WINDOW_HEIGHT - 100 # bottom 'breach' line
...
class Game():
    ...
    def update(self):
        """Update the game in the main loop"""
        self.shift_aliens()
    ...
    def draw(self):
        ...
        pygame.draw.line(display_surface, WHITE, (0, BREACH_LINE), (WINDOW_WIDTH, BREACH_LINE), 4)
    ...
    def check_collisions(self):
        ...
        # kill both sprites 'True', 'True', play a sound and increase the score
