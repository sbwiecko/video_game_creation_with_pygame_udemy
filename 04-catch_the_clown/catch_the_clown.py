...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            # detection of a collision btw a rect and a point
            if clown_rect.collidepoint(mouse_x, mouse_y):
                ...
                # the following condition ensures the new direction is different
                # from the previous, i.e., either new dx or dy is different
    ...
    # if clown touches one border it goes the opposite direction
