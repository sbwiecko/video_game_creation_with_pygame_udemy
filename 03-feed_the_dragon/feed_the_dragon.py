...
COIN_ACCELERATION = .5
# distance beyond the right border of the game window
# so that the coin does't appear instantaneously
# but rather smoothly from the right
BUFFER_DISTANCE = 100
...
while running:
    ...
    if player_rect.colliderect(coin_rect):
        score += 1
        coin_sound.play()
        # increase velocity and add new coin
